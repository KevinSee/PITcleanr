...
#' @param configurationFile data.frame with column called SiteID with site codes, a column called RKM with the river mask codes, and a column called SiteType with values of either \code{INT} for interrogation sites or \code{MMR} for mark/recapture/recovery sites
