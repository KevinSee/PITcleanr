...
```{r eval = F, child = here::here("man/fragments/query-ptagis.Rmd")}
```

```{r eval = T, child = "child_docs/query-ptagis.Rmd"}
```
...
```{r eval = F, child = here::here("man/fragments/compress-data.Rmd")}
```

```{r child = "child_docs/compress-data.Rmd"}
```


## Site Configuration

```{r eval = F, child = here::here("man/fragments/site-configuration.Rmd")}
```

```{r eval = T, child = "child_docs/site-configuration.Rmd"}
```
...
```{r child = "child_docs/extract-sites.Rmd"}
```


### Query Flowlines

```{r child = "child_docs/query-flowlines.Rmd"}
```
...
```{r child = "child_docs/parent-child.Rmd"}
```
