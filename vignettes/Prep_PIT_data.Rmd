...
ptagis_file = "C:/Users/username/Desktop/TUM_Chinook_2015.csv"

```

And then the `compress()` function can be performed on the file path. In our example, we write the output to an object `comp_obs` containing the compressed observations.
