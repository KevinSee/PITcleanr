...
The `PITcleanr` package can be installed as an R package from GitHub by using Hadley Wickham's `remotes` package:
...
`remotes` may require a working development environment. Further details around the installation of `remotes` can be found [here](https://cran.r-project.org/package=remotes).
...
* For Mac OS, that may involve installing Xcode from the Mac App Store.
